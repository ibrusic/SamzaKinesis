 ...
 */
public class KinesisSystemConsumerPrev extends BlockingEnvelopeMap {
    /**
     * AWS credentials
     */
     ...
     */
    private static final Log LOG = LogFactory.getLog(KinesisSystemConsumerPrev.class);
    /**
     * System name
     */
     ...
     * @param config
     */
    public KinesisSystemConsumerPrev(String systemName, Config config) {
